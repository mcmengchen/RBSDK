...
@interface RBTimerManager ()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation RBTimerManager

+ (RBTimerManager *)sharedInstance
{
    static RBTimerManager *leTimerManager = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^(){
        leTimerManager = [[RBTimerManager alloc] init];
    });
